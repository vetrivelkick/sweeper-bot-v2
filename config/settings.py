...
class SweeperConfig:
    ...
    max_resolution_minutes: int = field(default_factory=lambda: int(os.getenv("MAX_RESOLUTION_MINUTES", "0")))  # FIX R6: Max resolution time filter (minutes, 0=disabled, was 5)
